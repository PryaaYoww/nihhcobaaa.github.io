...
<html lang="en">
  ...
  <head>
    ...
    <script src="https://dekatutorial.github.i/sweetalert2.all.min.js"></script>
    ...
    <script>
      ...
      function sayangGak() {
        dekatutorial
          .fire({ showDenyButton: true,
            ...
            title: "Vidya Suka Ga Sama Web Kakak?",
            denyButtonText: "Ga",
            ...
            if (e.isConfirmed) {
              dekatutorial
                .fire({
                  ...
                  title: "Wah Makasih Banget Kakak Jadi Seneng",
      ...
      async function seberapaSayang() {
        ...
        await dekatutorial
          .fire({
            ...
            title: "Makasih ya udah suka sama hasil nyaa yg ga seberapa " + syg + "%",
      ...
      async function kangenGak() {
        await dekatutorial
          .fire({ showDenyButton: true,
            ...
            title: "Nii Kalo suka sama web nya suka sama kakak juga gaa hehe :)?",
            denyButtonText: "Ga",
            confirmButtonText: "Suka",
      ...
      async function pesanAkhir() {
        await dekatutorial.fire({
          ...
          title: "Makasih yaa udah di isii",
